              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>                
                    ...
                    <th scope="col" class="sort" data-sort="name" style="color:black; font-size=25; background:aqua;"><strong>Mã nhân viên</strong></th>
                    <th scope="col" class="sort" data-sort="status"style="color:black; font-size=25; background:aqua;"><strong>Mã khách hàng</strong></th>
                    <th scope="col" class="sort" data-sort="status"style="color:black; font-size=25; background:aqua;"><strong>Ngày đặt hàng</strong></th>
                    <th scope="col" class="sort" data-sort="status"style="color:black; font-size=25; background:aqua;"><strong>Ngày giao hàng</strong></th>
                  ...
                  <?php
                    ...
                    if($pre_page==0)
                      $list_page='<li class="page-item disabled"> 
                                  <a class="page-link" href="don-dat-hang.php?page='.$pre_page.'" tabindex="-1"><i class="fa fa-angle-left"></i>
                    ...
                    if($page-1 > 1){
                      $list_page.='<li class="page-item"><a class="page-link" href="don-dat-hang.php?page=1">1</a></li>';
                      if($page-1 > 2)
                    ...
                    for($i=$start;$i<=$end;$i++){
                      if($i==$page)
                        ...
                        $list_page.='<li class="page-item"><a class="page-link" href="don-dat-hang.php?page='.$i.'">'.$i.'</a></li>';
                    }
                    if($page+1<$total_page-1){
                      $list_page.='<li class="page-item "><span class="page-link" ><i class="fa fa-ellipsis-h"></i></span></li>';
                    }
                    if($page+1<$total_page)
                      $list_page.='<li class="page-item"><a class="page-link" href="don-dat-hang.php?page='.$total_page.'">'.$total_page.'</a></li>';
                   
                    //Trang sau
                    $next_page=$page+1;
                    if($next_page>$total_page)
                      $list_page.='<li class="page-item disabled"> 
                                  <a class="page-link" href="don-dat-hang.php?page='.$next_page.'" tabindex="-1"><i class="fa fa-angle-right"></i>
